    ...
    app.get('/api/status', (req, res) => {
      res.json({
        ...
        config: {
          ...
          entryMinMigrationAgeMs: config.earlyFlow.minMigrationAgeMs,
          entryMaxMigrationAgeMs: config.earlyFlow.maxMigrationAgeMs,
          entryMinPriceChangePct: config.earlyFlow.minPriceChangePct,
          entryMaxPriceChangePct: config.earlyFlow.maxPriceChangePct,
          entryMinUniqueBuyers5s: config.earlyFlow.minUniqueBuyers,
          entryMinTrades5s: config.earlyFlow.minTradeCount,
          entryMinBuySol5s: config.earlyFlow.minBuySol5s,
          entryMaxLargestBuyShare5s: config.earlyFlow.maxLargestBuyShare,
          entryRiskEnabled: config.earlyFlow.riskEnabled,
          entryRiskRejectScore: config.earlyFlow.riskRejectScore,
          entryRiskMinUniqueBuyers5s: config.earlyFlow.riskMinUniqueBuyers5s,
          entryRiskMinBuySol5s: config.earlyFlow.riskMinBuySol5s,
          entryRiskMinPriceChangePct: config.earlyFlow.riskMinPriceChangePct,
          entryRiskMaxLargestBuyShare: config.earlyFlow.riskMaxLargestBuyShare,
          entryRiskMaxExecutionDelayMs: config.earlyFlow.riskMaxExecutionDelayMs,
          entryRiskMinFdvUsd: config.earlyFlow.riskMinFdvUsd,
          entryRiskMaxMigrationAgeMs: config.earlyFlow.riskMaxMigrationAgeMs,
          solPriceUsd: config.earlyFlow.solPriceUsd,
          emaFastPeriod: config.strategy.emaFastPeriod,
          emaSlowPeriod: config.strategy.emaSlowPeriod,
          fdvExitUsd: config.strategy.fdvExitUsd,
          trailingActivatePct: config.strategy.trailingActivatePct,
          trailingDrawdownPct: config.strategy.trailingDrawdownPct,
          tailStopEnabled: config.strategy.tailStopEnabled,
          tailStopPnlPct: config.strategy.tailStopPnlPct,
          tailStopFlowWindowMs: config.strategy.tailStopFlowWindowMs,
          tailStopSellBuyRatio: config.strategy.tailStopSellBuyRatio,
          tailStopMaxUniqueBuyers: config.strategy.tailStopMaxUniqueBuyers,
          tailStopConfirmMs: config.strategy.tailStopConfirmMs,
          tailStopConfirmTrades: config.strategy.tailStopConfirmTrades,
          runnerEnabled: config.strategy.runnerEnabled,
          runnerActivatePct: config.strategy.runnerActivatePct,
          runnerTiers: config.strategy.runnerTiers,
          slowBleedExitEnabled: config.strategy.slowBleedExitEnabled,
          slowBleedMinHoldMs: config.strategy.slowBleedMinHoldMs,
          slowBleedMaxPeakPnlPct: config.strategy.slowBleedMaxPeakPnlPct,
          slowBleedMaxPnlPct: config.strategy.slowBleedMaxPnlPct,
          slowBleedSellBuyRatio: config.strategy.slowBleedSellBuyRatio,
          slowBleedMaxUniqueBuyers: config.strategy.slowBleedMaxUniqueBuyers,
          slowBleedConfirmMs: config.strategy.slowBleedConfirmMs,
          slowBleedConfirmTrades: config.strategy.slowBleedConfirmTrades,
          catastrophicStopEnabled: config.strategy.catastrophicStopEnabled,
          catastrophicStopPnlPct: config.strategy.catastrophicStopPnlPct,
          addonShadowEnabled: config.addonShadow.enabled,
